...
const Filter = () => {
    // Initialize state with an object to store selected values
    ...
    // Reset filters by clearing the state
    const resetFilter = () => {
        setFilters({
            price: '',
            sleeves: '',
    ...
    return (
        <div className="filter hidden min-h-screen bg-white z-50 fixed top-0 sm:relative sm:z-0 md:block w-fullz duration-1000 sm:w-1/5 sm:w-full max-w-[305px] border border-1">
