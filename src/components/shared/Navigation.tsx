          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div className="sm:mx-5 sm:mr-2 bg-white sm:relative absolute duration-500 top-0 -z-10 w-full left-0 px-2 sm:z-50 block ">
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      className="w-full xl:w-80 sm:w-full py-2 pl-10 pr-4 text-gray-700 bg-white focus:border-slate-400 focus:outline-none sm:border rounded-md"
                      placeholder="Search"
                      value={searchValue}
              ...
              <div className="flex lg:hidden">
                ...
                >
                  ...
                  >
                    {
                      toggle ? (<path d="M6 18L18 6M6 6l12 12" stroke-linecap="round" stroke-linejoin="round"></path> )
                      : (
                        <path
                          d="M4 8h16M4 16h16"
                          stroke-linecap="round"
...
{/* w-full px-6 py-2 transition-all duration-300 ease-in-out bg-blue-900 top-24 md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto opacity-100 md:translate-x-0 md:flex md:items-center  -translate-x-full" */}
<div className={`flex md:items-center md:flex-row`}>
              ...
              >
                ...
                <Link
                  className="my-2 flex gap-1 items-center text-base leading-5 text-gray-700 transition-colors duration-300 transform hover:text-blue-600 hover:underline md:mx-4 md:my-1"
                  to="/seller"
                >
                 <AiOutlineShop size={25}/> <span>Become a Seller</span>
                </Link>
                <Link
                  className="my-2 text-base leading-5 text-gray-700 transition-colors duration-300 transform hover:text-blue-600 hover:underline md:mx-4 md:my-1"
                  to="/about"
